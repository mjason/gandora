...
def names() -> list[str]:
    """Every construct that has a card — the index the pack ships.

    >>> "for" in names()
    True
"""
    return gandora_std.enum.sort(builtins.list(cards.keys()))
