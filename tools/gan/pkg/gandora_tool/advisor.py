...
def _mask_paren_sigils(source):
    starts = gandora_std.enum.map(builtins.list(re.finditer("(?:~[a-zA-Z]+|\\$python|%[a-z]+)\\(", source)), lambda m: ((m).end()))
